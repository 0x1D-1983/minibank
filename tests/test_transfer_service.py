...
def test_transfer_success(transfer_service: TransferService, bank: Bank) -> None:
...
def test_transfer_source_not_found(transfer_service: TransferService, bank: Bank) -> None:
...
def test_transfer_destination_not_found(
    transfer_service: TransferService, bank: Bank
) -> None:
...
def test_transfer_updates_both_accounts(transfer_service: TransferService, bank: Bank) -> None:
    bank.find_account(1).deposit(100)
